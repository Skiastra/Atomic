...
function COMMAND:OnRun(player, arguments)
	...
	Clockwork.player:Notify(player, "You have played on the server for: "..days.." Days - "..hours.." Hours - "..minutes.." Minutes - "..seconds.." Seconds.")
	Clockwork.player:Notify(player, "You have played on this character for: "..chardays.." Days - "..charhours.." Hours - "..charminutes.." Minutes - "..charseconds.." Seconds.")
end;

...
Clockwork.config:Add("mute_crouched", true, true);
//Clockwork.config:Add("step_volume", 1, true);
//Clockwork.config:Add("crouch_step_volume", 0.60, true);
Clockwork.config:Add("repair_amount", 0.20, true);
